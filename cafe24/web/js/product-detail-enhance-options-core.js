  ...
  function init(platform) {
    ...
    var cafe24OptionAdapter = (function createCafe24OptionAdapter() {
      ...
      function normalizeBasketItem(optionRow, packSize, flavorValue) {
        ...
        var basketElements = platform.getBasketElements(mainRow) || {};
        var quantity = basketElements.quantity;
        var controlsCell = basketElements.controlsCell;
        var quantityInput = basketElements.quantityInput;
        var quantityUp = basketElements.quantityUp;
        var quantityDown = basketElements.quantityDown;
        var deleteButton = basketElements.deleteButton;
    ...
    function getOriginalPrice() {
      ...
      return platform.getOriginalPriceFallback
        ? platform.getOriginalPriceFallback()
        : null;
    }
    ...
    function updateFlavorOptionPicker(state) {
      ...
      if (platform.updateFlavorSheet) {
        platform.updateFlavorSheet(flavorPicker, isHidden);
      }
    }
    ...
    function createFlavorOptions() {
      ...
      var options = FLAVOR_OPTIONS
        ...
        .join('');
      var sheet = document.createElement(platform.flavorSheetTagName);
      ...
      sheet.addEventListener('click', function (event) {
        ...
        if (
          platform.isFlavorSheetBackdropClick &&
          platform.isFlavorSheetBackdropClick(event, sheet)
        ) {
